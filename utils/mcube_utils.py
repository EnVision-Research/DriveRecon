...
# modified from here https://github.com/autonomousvision/
# sdfstudio/blob/370902a10dbef08cb3fe4391bd3ed1e227b5c165/
# nerfstudio/utils/marching_cubes.py#L201
    ...
    for i in range(N):
        for j in range(N):
            for k in range(N):
                ...
                zzz = (np.min(z) > level or np.max(z) < level)

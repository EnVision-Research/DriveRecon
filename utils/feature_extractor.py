...
class ViTExtractor:
    ...
    def create_model(model_type: str) -> nn.Module:
        if "dinov2" in model_type:
            ...
            # model = vits.vit_base(patch_size=14, img_size=518)
            # state_dict_vitb14 = torch.load("/root/.cache/torch/hub/checkpoints/dinov2_vitb14_pretrain.pth")
            # model.load_state_dict(state_dict_vitb14, strict=False)

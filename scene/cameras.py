...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy, image, image_input, gt_alpha_mask,
                 image_name, uid,
                 trans=np.array([0.0, 0.0, 0.0]), scale=1.0, data_device = "cpu",
                 # for waymo
                 sky_mask = None, depth_map = None, xyz_map=None, depth_any_map=None, semantic_mask = None, instance_mask = None,
        ...
        self.image_input = image_input.clamp(0.0, 1.0).to(self.data_device)
        ...
        self.depth_any_map = depth_any_map
